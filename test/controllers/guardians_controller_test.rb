...
class GuardiansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guardian" do
    assert_difference('Guardian.count') do
      post guardians_url, params: { guardian: { class_id: @guardian.class_id, user_id: @guardian.user_id } }
    end
  ...
  test "should update guardian" do
    patch guardian_url(@guardian), params: { guardian: { class_id: @guardian.class_id, user_id: @guardian.user_id } }
